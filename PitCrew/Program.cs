...
evaluate[0].Add(("99999999999999", RunProgram(input24.ToArray(), (0, 0, 0, 0), "99999999999999").c.z));
evaluate[1].Add(("11111111111111", RunProgram(input24.ToArray(), (0, 0, 0, 0), "11111111111111").c.z));
        ...
        foreach (var e in evaluate[k])
        {
            for (int j = 13; j >= 0; j--)
            {
                for (int i = 1; i < 10; i++)
                {
                    ...
                    {
                        var x = RunProgram(input24.ToArray(), (0, 0, 0, 0), test);
